...
--awful.util.tagnames = {  " ", " ", " ", " ", " ", " ", " ", " ", " ", " "  }
awful.util.tagnames = { " MAIN ", " DEV ", " DC ", " GAME ", " MEDIA ", " BG ", " DEP1 ", " DEP2 ", " SHOWCASE " }
...
local myawesomemenu = {
    ...
    { "edit config", "code /home/pizza/.config/awesome/rc.lua" },
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, "Shift"  }, "s", function() awful.util.spawn("scrot -e 'mv $f /home/pizza/screenshots/' --select --freeze --line mode=edge --quality 100 --silent") end,
