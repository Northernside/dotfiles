--[[
     ...
     northernsidetheme Awesome WM theme
     github.com/Northernside
...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/northernsidetheme"
...
theme.bg_normal                                 = "#344e41"
theme.bg_focus                                  = "#3a5a40"
theme.bg_urgent                                 = "#344e41"
theme.taglist_fg_focus                          = "#ffffff"
theme.tasklist_bg_focus                         = "#ffffff"
theme.tasklist_fg_focus                         = "#ffffff"
theme.border_width                              = 2
theme.border_normal                             = "#344e41"
theme.border_focus                              = "#344e41"
theme.border_marked                             = "#344e41"
   ...
   s.quake = lain.util.quake({ app = "termite", height = 0.50, argname = "--name %s" })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.contaier.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, 4, 7), "#343434"),
            arrow("alpha", "#588157"),
            wibox.container.background(wibox.container.margin(wibox.widget { mpdicon, theme.mpd.widget, layout = wibox.layout.align.horizontal }, 3, 6), "#588157"),

            arrow("#588157", "#69993d"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, 2, 3), "#69993d"),

            arrow("#69993d", "#588157"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, 3, 4), "#588157"),

            arrow("#588157", "#69993d"),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#69993d"),

            arrow("#69993d", "#588157"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#588157"),
            
            arrow("#588157", "#69993d"),
            wibox.container.background(wibox.container.margin(clock, 4, 8), "#69993d"),
            arrow("#69993d", "alpha"),
            --]]
            s.mylayoutbox,
        },
