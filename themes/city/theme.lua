...
theme.bg_normal                                 = "#191912"
theme.bg_focus                                  = "#433932"
theme.bg_urgent                                 = "#191912"
theme.taglist_fg_focus                          = "#ffffff"
theme.tasklist_bg_focus                         = "#ffffff"
theme.tasklist_fg_focus                         = "#ffffff"
theme.border_width                              = 2
theme.border_normal                             = "#191912"
theme.border_focus                              = "#191912"
theme.border_marked                             = "#191912"
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.contaier.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, 4, 7), "#343434"),
            arrow("alpha", "#505965"),
            wibox.container.background(wibox.container.margin(wibox.widget { mpdicon, theme.mpd.widget, layout = wibox.layout.align.horizontal }, 3, 6), "#505965"),

            arrow("#505965", "#798293"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, 2, 3), "#798293"),

            arrow("#798293", "#505965"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, 3, 4), "#505965"),

            arrow("#505965", "#798293"),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#798293"),

            arrow("#798293", "#505965"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#505965"),
            
            arrow("#505965", "#798293"),
            wibox.container.background(wibox.container.margin(clock, 4, 8), "#798293"),
            arrow("#798293", "alpha"),
            --]]
            s.mylayoutbox,
        },
